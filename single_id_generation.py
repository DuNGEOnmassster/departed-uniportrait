...
def main():
    parser = argparse.ArgumentParser(description="Text-to-Single-ID Generation")
    ...
    parser.add_argument("--face_structure_scale", type=float, default=0.1, help="Face Structure Scale")
